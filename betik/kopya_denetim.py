...
BETIKLER = ["tefas_cek.py", "gunluk_cron.sh", "arsiv_guncelle.py", "hisse_cek.py", "kap_kunye.py", "kategori.py", "fon_icerik_cek.py",
            ...
            "kapsam.py", "denetim.py", "brifing_pdf.py", "defter_pdf.py", "sayfa_html.py", "pdf_temel.py", "surum.py", "sinama_kap_izleme.py", "sinama_oneri.py", "sinama_icerik.py", "icerik_kapsam.py", "varsayimlar.py", "temel_cek.py", "requirements.txt", "kopya_denetim.py",
