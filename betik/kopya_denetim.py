...
BETIKLER = ["tefas_cek.py", "gunluk_cron.sh", "arsiv_guncelle.py", "hisse_cek.py", "kap_kunye.py", "kategori.py", "fon_icerik_cek.py",
            "kap_ucret.py", "tefas_yas.py", "kunye_tam_uret.py", "kurucu_grup_uret.py", "kap_gunluk.py", "kapilar.py", "parlayan_fon.py", "oneri.py", "kap_izleme.py", "takvim.py",
            "kapsam.py", "denetim.py", "brifing_pdf.py", "defter_pdf.py", "sayfa_html.py", "pdf_temel.py", "surum.py", "sinama_kap_izleme.py", "sinama_oneri.py", "sinama_icerik.py", "icerik_kapsam.py", "varsayimlar.py", "gerileme_denetimi.py", "temel_cek.py", "requirements.txt", "kopya_denetim.py",
