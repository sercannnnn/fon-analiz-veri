...
KAYITLAR = [
    ...
    ("B18", "fon_icerik_cek", "YENIDEN_CEKIM_TAVAN", 99, "bekliyor", "kuyruk-arşiv sapmasında tur başına yeniden çekim kuyruğuna alınan en çok fon sayısı; kalanı sonraki turlara", ""),
